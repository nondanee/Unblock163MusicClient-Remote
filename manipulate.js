...
module.exports = (req, res) => {
  ...
  return Promise.resolve()
    ...
    .then(() => request('POST', 'http://music.163.com/api/playlist/manipulate/tracks', { cookie, 'content-type': 'application/x-www-form-urlencoded' }, `trackIds=[${trackId},${trackId}]&pid=${pid}&op=${op}`))
